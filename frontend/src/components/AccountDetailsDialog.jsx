...
import { useUpdateAccountDetails } from "@/api/queries/authQueries";
...
export const AccountDetailsDialog = ({ open, onOpenChange }) => {
  ...
  const updateAccountMutation = useUpdateAccountDetails();
  ...
  const handleSubmit = (e) => {
    ...
    updateAccountMutation.mutate(formDataToSend, {
      onSuccess: () => {
        onOpenChange(false);
      },
    });
