...
/**
 * Send welcome email with login URL and auto-generated password
 * @param {string} email - Recipient email address
 * @param {string} password - Auto-generated password
 * @param {string} name - Employee name
 ...
 * @returns {Promise<Object>} - Email send result
 */
export const sendWelcomeEmailWithLoginUrl = async (email, password, name, loginUrl) => {
  const subject = 'Welcome to AAcounting - Your Account Credentials';
  const html = `
    <!DOCTYPE html>
    <html>
...
/**
 * Resolve the login URL from environment variables
 * @returns {string}
 */
export const getLoginUrl = () =>
  process.env.LOGIN_URL || process.env.FRONTEND_URL || 'http://localhost:5173';
